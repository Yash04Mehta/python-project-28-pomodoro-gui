...
timer_text = canvas.create_text(100, 130, text="00:00", font=(FONT_NAME, 35), fill="white")
...
start_bt.grid(row=2, column=0, sticky=E)

reset_bt = Button(text="Reset", highlightthickness=0, command=reset_timer)
reset_bt.grid(row=2, column=3, sticky=W)

checkmark = Label(fg=GREEN, font=(FONT_NAME, 20), bg=YELLOW, highlightthickness=0)
checkmark.grid(row=3, column=1, sticky=N)
